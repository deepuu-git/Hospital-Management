...
export const bannerStyles = {
  ...
  bannerContainer: "relative w-full max-w-5xl mx-auto my-8 px-4",

  // Main container with animated border
  mainContainer: "max-w-6xl mx-auto bg-white rounded-2xl shadow-sm px-5 py-8",

  // Border outline styles
  borderOutline: "hidden",
  outerAnimatedBand: "hidden",
  innerWhiteBorder: "hidden",
  // Content container
  contentContainer: "relative z-20 p-6 sm:p-8 lg:p-10",

  // Layout styles
  flexContainer: "flex flex-col lg:flex-row items-center gap-8",
  ...
  stethoscopeInner: "bg-emerald-100 p-3 rounded-full",
  stethoscopeIcon: "w-7 h-7 text-emerald-600",
  ...
  featureItem: "flex items-center gap-2 text-sm text-gray-600",
  ...
  bookButton:
    "px-6 py-3 rounded-xl bg-emerald-600 text-white font-semibold shadow hover:bg-emerald-700 transition-",
  bookButtonContent: "flex items-center justify-center gap-2",
  bookButtonIcon: "w-4 h-4",

  // Emergency call button
  emergencyButton:
    "px-6 py-3 rounded-xl border border-red-400 text-red-500 bg-white hover:bg-red-50 transition",
  ...
  imageFrame: "rounded-2xl overflow-hidden shadow-sm",
  image: "w-full h-full object-cover",
};
...
export const doctorsPageStyles = {
  // Main container
  mainContainer:
    "min-h-screen bg-linear-to-br from-emerald-50 to-teal-100 py-8 sm:py-10 px-3 sm:px-6 relative",
...
export const footerStyles = {
  ...
  // Contact info
  contactContainer: "space-y-2",
  contactItem:
    "flex items-center gap-2 text-gray-600 hover:text-emerald-700 transitio",
  ...
  // Quick Links
  quickLink:
    "flex items-center justify-center md:justify-start hover:text-emerald-800 transition-all duration-300 group text-sm md:text-base font-medium py-2 px-3 rounded-lg hover:bg-emerald-50 border border-transparent hover:border-emerald-200",
...
export const departmentStyles = {
  ...
  // Doctor card
  article:
    "group bg-white rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden",

  // Image containers
  imageContainerAvailable: "relative h-40 overflow-hidden",
  imageContainerUnavailable: "relative h-40 overflow-hidden opacity-80",
  image:
  ...
  // Card body
  cardBody: "p-4 space-y-3 text-center",
  doctorName: "text-lg font-semibold text-gray-900 text-center",
  specialization:
  ...
  buttonAvailable:
    "w-full py-3 rounded-full text-sm font-semibold bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2",
  buttonUnavailable:
  ...
  /* optional: slightly reduce spacing on very small devices */
...
export const navbarStyles = {
  // Main container
  navbarContainer:
    "sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-blue-200 transition-transform duration-500",
  ...
  // Content wrapper
  // Content wrapper
  contentWrapper: "max-w-7xl font-[pacifico] mx-auto px-4 sm:px-6 lg:px-8",

  flexContainer: "flex items-center justify-between h-28 md:h-24",

  // Logo section
  logoLink: "flex items-center gap-3",

  logoContainer: "relative w-32 h-32",
  logoImageWrapper: "w-full h-full flex items-center justify-center",
  logoImage: "w-full h-full object-contain",

  logoTextContainer: "block",

  logoTitle:
    "text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-blue-600",
  ...
  loginButton:
    "btn-login hidden lg:flex lg:text-sm items-center gap-2 bg-linear-to-r from-emerald-400 to-blue-600 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-xl transition-all duration-300 cursor-default",
  loginIcon: "w-4 h-4",
  ...
  mobileMenuItemInactive:
    "text-gray-700 hover:bg-emerald-50 hover:text-blue-600",
