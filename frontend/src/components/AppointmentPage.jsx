...
// Helper functions
// pad function return number here
function pad(n) {
...
// this function wil help in getting the status
...
const AppointmentPage = () => {
  ...
  // to load service appoinemts form the server side
  ...
  // to reshedule we have to normaliza the field with UI
