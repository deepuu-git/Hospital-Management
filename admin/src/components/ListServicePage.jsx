...
export default function ListServicePage() {
  ...
  // gives o/p with date and time like DD-MM-YYYY with HH:MM AM/PM
  ...
  // to prevent from duplicate slot to be present
  ...
  // convert slot obbj to timestamp in local timezone
