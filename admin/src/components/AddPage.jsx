...
import { Password, Schedule } from '@mui/icons-material';

import { Calendar, EyeClosed, Plus, User, XCircle, Eye, Trash2, CheckCircle } from 'lucide-react';
...
const AddPage = () => {
    ...
    // it will show a toast for 3sec only
    useEffect(() => {
    ...
    // it will convert schdeule object into an array.
    ...
    async function handleAdd(e) {
        e.preventDefault();
        if (!validate(form)) {
            showToast("error", "Fill all fileds + upload image + add slot");
            return;
        }
        ...
        <div className={s.pageContainer}>
            ...
            <div className={s.maxWidthContainer + " " + s.formContainer}>
                ...
                <input 
                    ...
                    <select className={s.inputBase} value={form.availability} onChange={(e) => 
                        setForm({
                            ...form,
                    ...
                    <div className={s.slotsGrid}>
                        {getFlatSlots(form.schedule).map(({ date, time }) => (
                            ...
                            >
                                ...
                                <button onClick={() => removeSlot(date, time)}
            ...
            {toast.show && (
                <div className={
                    s.toastContainer + " " + (toast.type === "success" ? s.toastSuccess : s.toastError)
                }
                >
                    {toast.type === "success" ? (
                        <CheckCircle size={22} />
            ...
            {/* Simple Overview of added doctor (doc)*/}
                            ...
                            <div key={d.id || d._id} className={s.doctorCard}>
                                <div className={s.doctorCardContent}>
                                    ...
                                    <div>
                                        ...
                                        <div className={s.doctorSpecialization}>{d.specailization}
