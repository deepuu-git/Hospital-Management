...
const AddService = ({ serviceId }) => {
  ...
  // initial values are string matching options
  ...
  function addSlot() {
    const monthNumber = String(Number(slotMonth) + 1).padStart(2, "0");
    ...
    const formatted = `${y}-${monthNumber}-${d} ${h}:${mm} ${ap}`;
    ...
    <div className={addServiceStyles.container.main}>
      ...
      <form onSubmit={handleSubmit} className={addServiceStyles.container.form}>
        <div className=" flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
          <div>
            ...
            <p className={addServiceStyles.header.subtitle}>
              Design an attractive service card along with customized time slots
        ...
        <div className={addServiceStyles.grids.main}>
          <div className=" lg:col-span-1 md:col-sapn-1 col-span-1 flex flex-col items-center">
            <div
