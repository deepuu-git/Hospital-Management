...
const Navbar = () => {
 ...
 const handleSignOut = async () => {
  ...
  try {
    ...
    console.error("Sing out failed", err);
  } finally {
   try {
    localStorage.removeItem("clerk_token");
   } 
      ...
      <nav className={ns.navContainer}>
        <div className={ns.flexContainer}>
          <div className={ns.logoContainer}>
            ...
            <Link to='/'>
            <div className={ns.logoLink}>LifeCare</div>
            <div className={ns.logoSubtext}>HealthCare Management System</div>
            </Link>
          </div>
