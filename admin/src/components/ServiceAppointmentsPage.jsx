...
// small component for stausBadge
...
// to prevent previous date comes first that  is upcoming date
...
const ServiceAppointmentsPage = () => {
  ...
  // to reshedule the app for later but not on previus days
          ...
          {displayList.length === 0 ? (
            <div className={serviceAppointmentsStyles.noResultsContainer}>
              ...
              <div className={serviceAppointmentsStyles.noResultsSubtext}>
                Try a different patientname or service
              </div>
            </div>
          ) : (
            displayList.map((a) => {
