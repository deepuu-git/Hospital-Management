...
export const doctorListStyles = {
  ...
  locationValue: "text-sm text-emerald-700 break-words",
...
export const heroStyles = {
  ...
  logo: "w-40 h-40 object-contain mx-auto",
...
export const serviceDashboardStyles = {
  ...
  // Main layout
  bannerContainer:
    "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-white to-green-50",

  mainContainer: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16",

  contentContainer:
    "bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-emerald-100 p-6 md:p-10",

  // Left content
  leftContent: "space-y-2",

  // Header section
  headerBadgeContainer: "flex items-center gap-4",

  stethoscopeContainer: "flex items-center justify-center",

  stethoscopeInner:
    "w-16 h-16 rounded-2xl bg-emerald-100 flex items-center justify-center shadow-md",
  ...
  // Buttons section
  ctaButtonsContainer: "flex flex-col sm:flex-row gap-4",

  // Book button
  bookButton:
    "relative overflow-hidden px-6 py-3 rounded-full bg-emerald-600 text-white font-semibold shadow-lg hover:scale-105 transition-all duration-300",

  bookButtonOverlay: "absolute inset-0 bg-white/10",
  ...
  // Emergency button
  emergencyButton:
    "px-6 py-3 rounded-full border border-emerald-200 bg-white text-emerald-700 font-semibold shadow hover:shadow-md transition-all duration-300",
  ...
  // Right image section
  rightImageSection: "flex items-center justify-center",

  imageContainer: "relative",

  imageFrame:
    "rounded-3xl overflow-hidden bg-emerald-50 p-3 shadow-xl border border-emerald-100",
};
